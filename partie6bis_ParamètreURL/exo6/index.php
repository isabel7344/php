...
$building = 'Param non présent ';
$room = 'Param non présent ';
...
<body>
    <div class="container">
        <div class="d-flex justify-content-center m-5">
            <a class="btn btn-primary" href=" index.php?building=12&room=101">Envoie des paramètre</a>
            <a class="btn btn-secondary" href="index.php">Retour Index</a>
        </div>
        <p class="text-center"> Param1 : <?= $building?>
        </p>
        <p class="text-center"> Param2 : <?= $room ?>
        </p>
