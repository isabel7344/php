...
$startDate = 'Param non présent ';
$endDate = 'Param non présent ';
...
<body>
    <div class="container">
        <div class="d-flex justify-content-center m-5">
            <a class="btn btn-primary" href="index.php?startDate=01/09/2019&endDate=17/03/2020">Envoie des paramètre</a>
            <a class="btn btn-secondary" href="index.php">Retour Index</a>
        </div>
        <p class="text-center"> Param1 : <?= $startDate ?>
        </p>
        <p class="text-center"> Param2 : <?= $endDate ?>
        </p>
